    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-neutral-50 p-4">
        <div className="w-full max-w-sm text-center">
          ...
          <h1 className="text-2xl font-bold text-neutral-900">Check your inbox</h1>
          ...
          <div className="mt-6 rounded-xl border border-neutral-200 bg-white p-4 text-left text-xs text-neutral-500">
            <p className="font-medium text-neutral-700 mb-1">Didn&apos;t receive it?</p>
        ...
        <div className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
          ...
          <div className="relative mb-4">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-white px-2 text-neutral-400">or sign up with email</span>
            </div>
          </div>
